...
namespace BsBios.Portal.Application.Services.Implementations
{
    public class ProcessoDeCotacaoFornecedoresService : IProcessoDeCotacaoFornecedoresService
    {
        ...
        public ProcessoDeCotacaoFornecedoresService(IUnitOfWork unitOfWork, IProcessosDeCotacao processosDeCotacao, IFornecedores fornecedores)
        {
        ...
        public void AtualizarFornecedores(ProcessoDeCotacaoFornecedoresAtualizarVm atualizacaoDosFornecedoresVm)
        {
            try
            {
                ...
                var processoDeCotacaoDeMaterial = _processosDeCotacao.BuscaPorId(atualizacaoDosFornecedoresVm.IdProcessoCotacao).Single();

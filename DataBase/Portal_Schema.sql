...
ALTER TABLE REQUISICAOCOMPRA 
ADD (IDPROCESSOCOTACAOITEM NUMBER );
...
--CRIAÇÃO DA COLUNA DE TIPO DE FRETE (INICIO)
ALTER TABLE COTACAOMATERIAL 
ADD (TIPODEFRETE NUMBER );

ALTER TABLE COTACAOMATERIAL
ADD CONSTRAINT CHK_COTACAOMATERIAL_TIPOFRETE CHECK 
(TIPODEFRETE BETWEEN 1 AND 2)
ENABLE;
--CRIAÇÃO DA COLUNA DE TIPO DE FRETE (FIM)

...
ALTER TABLE ORDEMDETRANSPORTE ADD STATUSDECOLETA NUMBER(1,0);

UPDATE ORDEMDETRANSPORTE SET STATUSDECOLETA = 0;

COMMIT;

ALTER TABLE ORDEMDETRANSPORTE MODIFY STATUSDECOLETA NUMBER(1,0) NOT NULL;

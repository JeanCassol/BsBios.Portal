...
ALTER TABLE COTACAOITEM 
ADD (VALORLIQUIDOINICIAL NUMBER(13, 2) );

UPDATE COTACAOITEM SET VALORLIQUIDOINICIAL = VALORLIQUIDO
WHERE VALORLIQUIDOINICIAL IS NULL;
COMMIT;

ALTER TABLE COTACAOITEM  
MODIFY (VALORLIQUIDOINICIAL NOT NULL);

...
namespace BsBios.Portal.Tests.UI.Controllers
{
    ...
    public class ProcessoDeCotacaoFornecedoresServiceControllerTests
    {
        ...
        public void QuandoAtualizarOsFornecedoresDoProcessoDeCotacaoCorretamenteDeveRetornarMensagemDeSucesso()
        {
            ...
            processoDeCotacaoFornecedoresServiceMock.Setup(x => x.AtualizarFornecedores(It.IsAny<AtualizacaoDosFornecedoresDoProcessoDeCotacaoVm>()));
            ...
            processoDeCotacaoFornecedoresServiceMock.Verify(x=> x.AtualizarFornecedores(It.IsAny<AtualizacaoDosFornecedoresDoProcessoDeCotacaoVm>()), Times.Once());
        }
        [TestMethod]

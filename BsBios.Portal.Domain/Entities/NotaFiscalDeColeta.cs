...
namespace BsBios.Portal.Domain.Entities
{
    public class NotaFiscalDeColeta
    {
        ...
        public NotaFiscalDeColeta(string numero, string serie, DateTime dataDeEmissao, decimal peso, decimal valor)
        {
            Numero = numero;
            Serie = serie;
        ...
        public virtual void Atualizar(string numero, string serie, DateTime dataDeEmissao, decimal peso, decimal valor)
        {
            Numero = numero;
            Serie = serie;
            DataDeEmissao = dataDeEmissao;

...
namespace BsBios.Portal.Domain.Entities
{
    ...
    public class CotacaoMaterial: Cotacao
    {
        ...
        {
            var cotacaoItem = (CotacaoItemMaterial)Itens.SingleOrDefault(item => item.ProcessoDeCotacaoItem.Id == processoDeCotacaoItem.Id);
            if (cotacaoItem != null)
            {
            ...
            {
                cotacaoItem = new CotacaoItemMaterial(this, processoDeCotacaoItem, mva, prazoDeEntrega, valorTotalComImpostos, quantidadeDisponivel, observacoes);
